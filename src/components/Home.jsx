...
const Home = () => {
  ...
  return (
    <>
      <div className="flex flex-row w-full" style={{height:'100vh'}}>
        <SideBar triggerChatUser={triggerChatUser} chatUser={chatUser} hideSideBar={hideSideBar} toggleSearchUser={toggleSearchUser} toggleSideBar={toggleSideBar}/>
        {chatUser && <UserDetails chatUser={chatUser} />}
      </div>

      {/* <div className="flex justify-center items-center bg-secondary flex-col gap-2">
        <div>
          <svg
            viewBox="0 0 303 172"
            width="360"
        ...
        <h1 className="text-4xl text-gray-400">Whatsapp Web</h1>
